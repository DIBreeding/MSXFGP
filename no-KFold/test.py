...
pyc_path = 'ISSA-XGBOOST-no-KFold.pyc'
...
pop_size=50
max_iters=100
test_size=0.1 #The ratio of the training set to the test set, 0.1 represents 9:1
...
module.MYISSA(p_X=X,p_y=y,p_test_size=test_size,p_lb=lb,p_ub=ub,p_step=int(X.shape[1]/125)+2,p_pop_size=pop_size, p_max_iters=max_iters,output_path=outpath,p_early_stop_threshold1=50)
